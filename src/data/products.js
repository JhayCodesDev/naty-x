...
export const CATEGORIES = [
  {
    id: "tees",
    name: "NXT Tees",
    image: "/product-images/NXT-statements-tee.jpg",
  },
  { id: "t-shirts", name: "T-Shirts", image: "/product-images/NXT-coming-soon-banner.jpg" },
  { id: "oversized", name: "Oversized", image: "/product-images/NXT-coming-soon-banner.jpg" },
  { id: "hoodies", name: "Hoodies", image: "/product-images/NXT-coming-soon-banner.jpg" },
  { id: "joggers", name: "Joggers", image: "/product-images/NXT-blessed-joggers-navy.jpg" },
  { id: "sweatshirts", name: "Sweatshirts", image: "/product-images/NXT-coming-soon-banner.jpg" },
  { id: "caps", name: "Caps", image: "/product-images/NXT-coming-soon-banner.jpg" },
  { id: "accessories", name: "Accessories", image: "/product-images/NXT-coming-soon-banner.jpg" },
];
...
export const PRODUCTS = [
  base({
    ...
    images: {
      Black: ["/product-images/NXT-statement-black.jpg"],
      White: ["/product-images/NXT-statement.jpg"],
      Multi: ["/product-images/NXT-statements-tee.jpg"],
    },
    featured: true,
    newArrival: true,
    description:
  ...
  base({
    ...
    colors: ["White", "Black"],
    images: {
      Black: ["/product-images/NXT-trend-setters-black.jpg"],
      White: ["/product-images/NXT-trend-setters.jpg"],
    },
    featured: true,
    newArrival: true,
    description:
  ...
  base({
    ...
    images: {
      Grey: ["/product-images/NXT-JDM-tuner.jpg"],
      Black: ["/product-images/NXT-JDM-tuner.jpg"],
      White: ["/product-images/NXT-JDM-tuner.jpg"],
    },
    featured: true,
    newArrival: true,
    description:
  ...
  base({
    ...
    images: {
      Navy: ["/product-images/NXT-bleesed-navy.jpg"],
      Black: ["/product-images/NXT-blessed-washed-black.jpg"],
      White: ["/product-images/NXT-blessed-white.jpg"],
    },
    featured: true,
    newArrival: true,
    description:
  ...
  base({
    ...
    colors: ["Black", "White"],
    images: {
      Navy: ["/product-images/NXT-blessed-joggers-navy.jpg"],
      Black: ["/product-images/NXT-blessed-joggers-black.jpg"],
      White: ["/product-images/NXT-blessed-joggers-white.jpg"],
    },
    featured: true,
    newArrival: true,
    description:
  ...
  base({
    ...
    colors: ["Black", "White"],
    images: {
      Black: ["/product-images/NXT-shadow-hood-black.jpg"],
      White: ["/product-images/NXT-shadow-hood-white.jpg"],
    },
    featured: true,
    newArrival: true,
    description:
  ...
  base({
    ...
    colors: ["Black", "White"],
    images: {
      White: ["/product-images/NXT-skull-head-white.jpg"],
      Black: ["/product-images/NXT-skull-head-white.jpg"],
    },
    featured: true,
    newArrival: true,
    description:
